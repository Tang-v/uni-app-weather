		...
		<view class="more-day-report">
			...
			<view class="body-module">
				...
				<view class="body-item" v-for="(item, index) in weatherData" :key="index">
					...
					<view class="max-weather">{{ item.day.temphigh }}</view>
					<view class="weather-line"></view>
					<view class="min-weather">{{ item.night.templow }}</view>
					<view class="feng-font">{{ item.day.winddirect}}</view>
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		methods: {
			...
			initWeatherPointLine() {
				...
				var cvs = uni.createCanvasContext('weather-canvas');
